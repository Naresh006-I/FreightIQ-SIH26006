...
function SailLogoSVG({ size = 48 }) {
  return (
    <svg width={size} height={size + 14} viewBox="0 0 60 74" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="6" y="6" width="48" height="48" rx="2" fill="#003087" transform="rotate(45 30 30)" />
      <rect x="13" y="13" width="34" height="34" rx="1" fill="none" stroke="white" strokeWidth="3" transform="rotate(45 30 30)" />
      <polyline points="18,34 30,20 42,34" fill="none" stroke="white" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
      <text x="30" y="70" textAnchor="middle" fontSize="11" fontWeight="700" fill="#003087" fontFamily="Arial, sans-serif">
        सेल SAIL
      </text>
    </svg>
  )
...
export default function Header({ activeTab, onTabChange }) {
  return (
    <header style={{ position:'sticky', top:0, zIndex:100, boxShadow:'0 2px 8px rgba(0,48,135,0.18)' }}>
      ...
      <div style={{ background:'#fff', borderBottom:'1px solid #dde3f4' }}>
        <div style={{ maxWidth:1280, margin:'0 auto', padding:'8px 20px',
          ...
          <div style={{ borderLeft:'2px solid #003087', paddingLeft:14 }}>
            <div style={{ fontWeight:800, fontSize:15, color:'#003087', lineHeight:1.2 }}>
              Steel Authority of India Limited (SAIL)
            </div>
            <div style={{ fontSize:11, color:'#6b7a9e', marginTop:3 }}>
              Ministry of Steel &nbsp;&middot;&nbsp; Government of India &nbsp;&middot;&nbsp; Freight Intelligence Platform
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background:'#003087' }}>
        <div style={{ maxWidth:1280, margin:'0 auto', padding:'0 20px', display:'flex', alignItems:'stretch' }}>
          ...
          {/* Platform title */}
          <div style={{ padding:'11px 22px 11px 0', borderRight:'1px solid rgba(255,255,255,0.18)',
