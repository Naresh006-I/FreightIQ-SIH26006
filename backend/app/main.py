...
from app.api import dashboard, forecast, vessels, arbitrage, risk, scheduler, analyze, whatif, bdi, route_optimizer, voyage_disruption, db_api, algorithms, advanced_models_api
...
for _mod in [dashboard, forecast, vessels, arbitrage, risk, scheduler, analyze, whatif, bdi, route_optimizer, voyage_disruption, db_api, algorithms, advanced_models_api]:
